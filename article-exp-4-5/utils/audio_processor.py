...
class AudioProcessor(object):
    ...
    def wav2feature(self, y):
        # print("ap", self.n_fft, self.win_length,
        #       self.hop_length, self.mel_fmax, self.mel_fmin, self.sample_rate, self.num_mels, self.log_mels, self.num_freq)
    ...
    def load_wav(self, path):
        ...
        # wav, sample_rate = torchaudio.load(path, normalize=True)
        # print(torch.max(wav))
